...
resource "aws_iam_role_policy" "lambda_function_bedrock_amazon_image_text_image" {
  name   = aws_iam_role.lambda_function_bedrock_amazon_image_text_image.name
  policy = data.aws_iam_policy_document.lambda_function_bedrock_amazon_image_text_image.json
  role   = aws_iam_role.lambda_function_bedrock_amazon_image_text_image.id
}
