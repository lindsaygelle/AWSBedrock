resource "aws_api_gateway_deployment" "bedrock" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      # aws_api_gateway_model.bedrock_amazon_image_image_variation_write_request,
      # aws_api_gateway_model.bedrock_amazon_image_inpainting_write_request,
      # aws_api_gateway_model.bedrock_amazon_image_outpainting_write_request,
      ...
      # aws_api_gateway_resource.bedrock_amazon_image_image_variation,
      # aws_api_gateway_resource.bedrock_amazon_image_inpainting,
      # aws_api_gateway_resource.bedrock_amazon_image_outpainting,
      aws_api_gateway_resource.bedrock_amazon_image_text_image,
      aws_api_gateway_resource.bedrock_amazon_text,
      # aws_api_gateway_method.bedrock_amazon_image_image_variation_post,
      # aws_api_gateway_method.bedrock_amazon_image_inpainting_post,
      # aws_api_gateway_method.bedrock_amazon_image_outpainting_post,
      aws_api_gateway_method.bedrock_amazon_image_text_image_post,
      aws_api_gateway_method.bedrock_amazon_text_post,
      # aws_api_gateway_integration.bedrock_amazon_image_image_variation_post,
      # aws_api_gateway_integration.bedrock_amazon_image_inpainting_post,
      # aws_api_gateway_integration.bedrock_amazon_image_outpainting_post,
      ...
      # aws_api_gateway_integration_response.bedrock_amazon_image_image_variation_post_200,
      # aws_api_gateway_integration_response.bedrock_amazon_image_inpainting_post_200,
      # aws_api_gateway_integration_response.bedrock_amazon_image_outpainting_post_200,
