resource "aws_api_gateway_integration" "bedrock_text_post" {
  credentials             = aws_iam_role.api_gateway_rest_api_bedrock.arn
  http_method             = aws_api_gateway_method.bedrock_text_post.http_method
  ...
  resource_id = aws_api_gateway_method.bedrock_text_post.resource_id
  rest_api_id = aws_api_gateway_method.bedrock_text_post.rest_api_id
  type        = "AWS"
